...
I plan to choose my Book Tracker idea. There is a few edits and methods I will need to add based on the comments given, but I believe that this will be the most feasilble out of all three. My spaceship navigator might involve a lot of math and the game inventory is an interesting idea but I am not that intrigued by it. The Book Tracker is something I am both really interested and is also something I will be able to make for this semester/project.
